 ...
 * Generated for Laravel 5.2.45 on 2017-08-19.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class DB {
        ...
        {
            //Method inherited from \Illuminate\Database\Connection            
            return \Phaza\LaravelPostgis\PostgisConnection::cursor($query, $bindings, $useReadPdo);
        }
    ...
    class Schema {
        ...
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
            return \Phaza\LaravelPostgis\Schema\Builder::enableForeignKeyConstraints();
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
            return \Phaza\LaravelPostgis\Schema\Builder::disableForeignKeyConstraints();
        }
...
namespace Stevebauman\Location\Facades {
    ...
    class Location {
         ...
         *
         * @param \Stevebauman\Location\DriverInterface $driver
         * @static 
         */
         ...
         * @static 
         */
        public static function get($ip = '', $field = '')
        {
            return \Stevebauman\Location\Location::get($ip, $field);
        }
        ...
        {
            return \Stevebauman\Location\Location::getConfig();
        }
         ...
         * @static 
         */
        public static function lists($value = '', $name = '')
        {
            return \Stevebauman\Location\Location::lists($value, $name);
        }
         ...
         * @static 
         */
        public static function dropdown($value = '', $name = '')
        {
            return \Stevebauman\Location\Location::dropdown($value, $name);
        }
         ...
         * @static 
         */
        public static function is($field)
        {
            return \Stevebauman\Location\Location::is($field);
        }
...
namespace EllisTheDev\Robots {
    ...
    class RobotsFacade {
        ...
        {
            return \EllisTheDev\Robots\Robots::generate();
        }
        ...
        {
            return \EllisTheDev\Robots\Robots::addSitemap($sitemap);
        }
        ...
        {
            return \EllisTheDev\Robots\Robots::addUserAgent($userAgent);
        }
        ...
        {
            return \EllisTheDev\Robots\Robots::addHost($host);
        }
        ...
        {
            return \EllisTheDev\Robots\Robots::addDisallow($directories);
        }
        ...
        {
            return \EllisTheDev\Robots\Robots::addAllow($directories);
        }
        ...
        {
            return \EllisTheDev\Robots\Robots::addComment($comment);
        }
        ...
        {
            return \EllisTheDev\Robots\Robots::addSpacer();
        }
        ...
        {
            \EllisTheDev\Robots\Robots::reset();
        }
...
namespace {
    ...
    class Robots extends \EllisTheDev\Robots\RobotsFacade {}
