...
$(function(){
    ...
    $("#dataTableBuilder_processing")
        .html("<i class='fa fa-spinner fa-spin'></i> Aguarde, processando informação! Se demorar demais, <a class='text-green btn-refresh-page' style='cursor: pointer'>clique aqui</a> para recarregar a página")
        .css({
            "padding" : "10px",
            "background" : "#eee",
            "margin-top" : "5px"
    ...
    $("select[name=user_type]").on('change', function(){
        ...
        if($(this).val() == 2){
            $(".cpf, .crm").slideDown(150);
            $("input[name=cpf], input[name=crm]").attr("required", true);
        }else{
            $(".cpf, .crm").slideUp(150);
            $("input[name=cpf], input[name=crm]").removeAttr("required");
        }
    });
...
//    submitando forms
    $("#form_new_plan").on('submit', function(){
       $(".box").append('<div class="overlay text-center"><h2>Aguarde alguns instantes, estamos avisando todos médicos disso!</h2><div class="spinner"></div><style>.spinner{width: 40px; height: 40px; margin: 25px auto; background-color: #333; border-radius: 100%; -webkit-animation: sk-scaleout 1.0s infinite ease-in-out; animation: sk-scaleout 1.0s infinite ease-in-out;}@-webkit-keyframes sk-scaleout{0%{-webkit-transform: scale(0)}100%{-webkit-transform: scale(1.0); opacity: 0;}}@keyframes sk-scaleout{0%{-webkit-transform: scale(0); transform: scale(0);}100%{-webkit-transform: scale(1.0); transform: scale(1.0); opacity: 0;}}</style></div>');
    });

    $("#form_new_spec").on('submit', function(){
        $(".box").append('<div class="overlay text-center"><h2>Aguarde alguns instantes, estamos avisando todos médicos disso!</h2><div class="spinner"></div><style>.spinner{width: 40px; height: 40px; margin: 25px auto; background-color: #333; border-radius: 100%; -webkit-animation: sk-scaleout 1.0s infinite ease-in-out; animation: sk-scaleout 1.0s infinite ease-in-out;}@-webkit-keyframes sk-scaleout{0%{-webkit-transform: scale(0)}100%{-webkit-transform: scale(1.0); opacity: 0;}}@keyframes sk-scaleout{0%{-webkit-transform: scale(0); transform: scale(0);}100%{-webkit-transform: scale(1.0); transform: scale(1.0); opacity: 0;}}</style></div>');
    });

    $("#form_new_exam").on('submit', function(){
        $(".box").append('<div class="overlay text-center"><h2>Aguarde alguns instantes, estamos avisando todos médicos disso!</h2><div class="spinner"></div><style>.spinner{width: 40px; height: 40px; margin: 25px auto; background-color: #333; border-radius: 100%; -webkit-animation: sk-scaleout 1.0s infinite ease-in-out; animation: sk-scaleout 1.0s infinite ease-in-out;}@-webkit-keyframes sk-scaleout{0%{-webkit-transform: scale(0)}100%{-webkit-transform: scale(1.0); opacity: 0;}}@keyframes sk-scaleout{0%{-webkit-transform: scale(0); transform: scale(0);}100%{-webkit-transform: scale(1.0); transform: scale(1.0); opacity: 0;}}</style></div>');
    });
