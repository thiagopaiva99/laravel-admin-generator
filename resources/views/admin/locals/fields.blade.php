...
<div class="col-md-12 center-align">
    ...
    <!-- Specialization -->
    <div class="form-group col-sm-12 col-md-4">
        {!! Form::label("specializations", "Especialidades:") !!}
        {!! Form::select("specializations[]", $specializations, isset($local) ? $local->specializations->pluck("id")->toArray() : null, ['class' => 'form-control select-multple select-specializations', 'multiple' => 'multiple', 'required' => 'true']) !!}
    </div>
</div>
