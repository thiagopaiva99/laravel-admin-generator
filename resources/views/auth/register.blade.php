...
<body class="hold-transition register-page" style="background: #fafafa;">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            {{--<div class="row">--}}
                ...
                <div class="pull-right">
                    <button type="submit" class="btn btn-success"><i class="fa fa-plus"></i> Register</button>
                </div>
                <!-- /.col -->
            {{--</div>--}}
        </form>

        <a href="{{ url('/login') }}" class="text-center text-green">Eu já tenho uma conta</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
