...
<head>
    ...
    <title>Docsaúde | Painel Administrativo</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form method="post" action="{{ url('/login') }}">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="">
                        Manter-se conectado?
                        <input type="checkbox" name="remember" data-toggle="toggle" data-size="normal" data-on="Sim" data-off="Não" data-onstyle="success" data-height="30" data-width="100">
                    </div>
                </div>
                <!-- /.col -->
                <br>
        ...
        <a href="{{ url('/password/reset') }}" class="text-green">Esqueci minha senha</a><br>
        <a href="{{ url('/register') }}" class="text-center text-green">Cadastrar novo usuário</a>
