...
class DropOldFunctions extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("DROP FUNCTION fn_available_appointments_for_date(DATE, INTEGER);");
        DB::statement("DROP FUNCTION fn_available_appointments_slots_for_date(DATE, INTEGER);");
        DB::statement("DROP FUNCTION fn_available_appointments_slots_for_date(TIMESTAMP, INTEGER);");
        DB::statement("DROP FUNCTION fn_next_available_appointment_datetime(INTEGER);");
        DB::statement("DROP FUNCTION fn_next_available_appointment_slot(INTEGER);");
        DB::statement("DROP FUNCTION fn_next_availables_appointment(INTEGER);");
    ...
    {
        DB::statement("CREATE TYPE available_appointment AS (
        ...
        DB::statement("
            CREATE OR REPLACE FUNCTION fn_available_appointments_for_date(dt date, id_local integer)
