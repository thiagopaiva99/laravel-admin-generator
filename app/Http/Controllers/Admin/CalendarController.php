...
//                $user_local = Local::find($local->id);
//
//                if(!is_null($user_local)){
//                    if(Local::find($user_local->id)->user_id == Auth::user()->id)
//                        $user_local = Local::find($local->id);
//                }else{
//                    $user_local = Local::where('user_id', Auth::user()->id)->first();
//                }
//
//                //verificando se o local que o medico passou é realmente dele
//                if($user_local->user_id != Auth::id()){
//                    $user_local = Local::where('user_id', Auth::user()->id)->get();
//                }
