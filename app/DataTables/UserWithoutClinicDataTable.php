...
class UserWithoutClinicDataTable extends DataTable
{
    ...
    public function ajax()
    {
        ...
        return $this->datatables->collection(User::where("user_type", 2)->has("clinics", "<", "1")->get())
            ->addColumn('action', 'admin.users.datatables_actions')
            ->editColumn('preferred_user', function($user) {
                if ($user->user_type == 2) {
                    return $user->preferred_user ? "Sim" : "Não";
                }
                return "";
            })
    ...
    private function getColumns()
    {
        return [
            ...
            'preferred_user' => ['name' => 'preferred_user', 'data' => 'preferred_user', "title" => "Preferencial"],
